...
const Book = ({ room }) => {
    ...
    const [departure_date, setDepartureDate_] = useState('');
    ...
    const bookingData = async () => {
        try {
            ...
            setDepartureDate_(booking_info.departureDate);
    ...
    const handleReserveRoom = async () => {
        try {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Saved!',
                text: 'Successfully reserved your room.',
            ...
            Swal.fire({
                icon: 'error',
                title: 'Failed!',
                text: 'Error occurred while trying to reserve. Please try again!',
                showConfirmButton: false,
                timer: 3000,
            });
        }
    ...
    const handleBooking = (async (e) => {
        ...
        if (arrivalDate >= currentDate) {
            if (bookedDate && arrivalDate >= bookedDate) {
                if (departureDate <= departure_date) {
                ...
                // Reserve and store data into firestore database
                await handleReserveRoom();
            }
        } else {
